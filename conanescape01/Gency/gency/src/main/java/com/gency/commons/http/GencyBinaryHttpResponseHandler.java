...
public abstract class GencyBinaryHttpResponseHandler extends GencyAsyncHttpResponseHandler {
    ...
    public GencyBinaryHttpResponseHandler(String[] allowedContentTypes) {
        ...
        if (allowedContentTypes != null)
            ...
            GencyDLog.e(LOG_TAG, "Constructor passed allowedContentTypes was null !");
    }
    ...
    public final void sendResponseMessage(HttpResponse response) throws IOException {
        ...
        for (String anAllowedContentType : getAllowedContentTypes()) {
            try {
                ...
                GencyDLog.e("BinaryHttpResponseHandler", "Given pattern is not valid: " + anAllowedContentType+" Exception : "+e.toString());
            }
        }
