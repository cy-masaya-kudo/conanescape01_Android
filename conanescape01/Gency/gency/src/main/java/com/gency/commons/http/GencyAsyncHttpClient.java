...
public class GencyAsyncHttpClient {
    ...
    public GencyAsyncHttpClient() {
        this(getDefaultSchemeRegistry(80, 443));
    }
    ...
    public GencyAsyncHttpClient(int httpPort) {
        this(getDefaultSchemeRegistry(httpPort, 443));
    }
    ...
    private static SchemeRegistry getDefaultSchemeRegistry(int httpPort, int httpsPort) {
        if (httpPort < 1) {
            httpPort = 80;
            GencyDLog.d(LOG_TAG, "Invalid HTTP port number specified, defaulting to 80");
        }

        if (httpsPort < 1) {
            httpsPort = 443;
            GencyDLog.d(LOG_TAG, "Invalid HTTPS port number specified, defaulting to 443");
        }
