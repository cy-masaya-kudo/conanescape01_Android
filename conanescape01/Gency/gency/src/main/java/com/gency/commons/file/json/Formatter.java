...
import com.gency.commons.file.json.JSON.Mode;
...
interface Formatter {
	boolean format(JSONContext context, Object src, Object o, OutputSource out) throws Exception;
}

final class NullFormatter implements Formatter {
	public static final NullFormatter INSTANCE = new NullFormatter();

	public boolean format(final JSONContext context, final Object src, final Object o, final OutputSource out) throws Exception {
		out.append("null");
		return false;
	}
}
...
final class StringFormatter implements Formatter {
	...
	static void serialize(final JSONContext context, final String s, final OutputSource out) throws Exception {
		out.append('"');
		int start = 0;
...
final class ObjectFormatter implements Formatter {
	...
	static List<PropertyInfo> getGetProperties(JSONContext context, Class<?> c) {
