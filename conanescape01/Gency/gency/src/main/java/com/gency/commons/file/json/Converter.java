...
import com.gency.commons.file.json.util.BeanInfo;
...
interface Converter {
	Object convert(JSONContext context, Object value, Class<?> c, Type t) throws Exception;
}

final class NullConverter implements Converter {
	public static final NullConverter INSTANCE = new NullConverter();
	
	public Object convert(JSONContext context, Object value, Class<?> c, Type t) {
		return null;
	}
}
...
final class FormatConverter implements Converter {
	...
	public Object convert(JSONContext context, Object value, Class<?> c, Type t) throws Exception {
		JSONContext context2 = context.copy();
...
final class DateConverter implements Converter {
	...
	static Date convertDate(JSONContext context, String value) throws ParseException {
		value = value.trim();
		if (value.length() == 0) {
			return null;
		}
...
final class ObjectConverter implements Converter {
	...
	private static Map<String, PropertyInfo> getSetProperties(JSONContext context, Class<?> c) {
	...
	private static String toLowerCamel(JSONContext context, String name) {
		StringBuilder sb = context.getLocalCache().getCachedBuffer();
