...
public abstract class GencyAsyncHttpResponseHandler implements GencyResponseHandlerInterface {
     ...
     */
    public void onProgress(int bytesWritten, int totalSize) {
        GencyDLog.d(LOG_TAG, String.format("Progress %d from %d (%d%%)", bytesWritten, totalSize, (totalSize > 0) ? (bytesWritten / totalSize) * 100 : -1));
    }
    ...
    public void onRetry(int retryNo) {
        GencyDLog.d(LOG_TAG, String.format("Request retry no. %d", retryNo));
    }

    public void onCancel() {
        GencyDLog.d(LOG_TAG, "Request got cancelled");
    }
        ...
        switch (message.what) {
            case SUCCESS_MESSAGE:
                ...
                if (response != null && response.length >= 3) {
                    ...
                    GencyDLog.e(LOG_TAG, "SUCCESS_MESSAGE didn't got enough params");
                }
                break;
            case FAILURE_MESSAGE:
                ...
                if (response != null && response.length >= 4) {
                    ...
                    GencyDLog.e(LOG_TAG, "FAILURE_MESSAGE didn't got enough params");
                }
                break;
            case START_MESSAGE:
                onStart();
            ...
            case PROGRESS_MESSAGE:
                ...
                if (response != null && response.length >= 2) {
                    try {
                        ...
                        GencyDLog.e(LOG_TAG, "custom onProgress contains an error : "+t.toString());
                    }
                } else {
                    GencyDLog.e(LOG_TAG, "PROGRESS_MESSAGE didn't got enough params");
                }
                break;
            case RETRY_MESSAGE:
                response = (Object[]) message.obj;
                if (response != null && response.length == 1)
                    ...
                    GencyDLog.e(LOG_TAG, "RETRY_MESSAGE didn't get enough params");
                break;
            case CANCEL_MESSAGE:
                onCancel();
                break;
