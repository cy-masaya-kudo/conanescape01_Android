...
class GencySimpleMultipartEntity implements HttpEntity {
    ...
    public void addPart(final String key, final String value, final String contentType) {
        try {
            ...
            GencyDLog.e(LOG_TAG, "addPart ByteArrayOutputStream exception : "+ e.toString());
        }
    }
    ...
    public void addPart(String key, String streamName, InputStream inputStream, String type)
        ...
        try {
            ...
            GencyDLog.w(LOG_TAG, "Cannot close input stream : "+ e.toString());
        }
    }
    ...
    private class FilePart {
        ...
        private byte[] createHeader(String key, String filename, String type) {
            ...
            try {
                ...
                GencyDLog.e(LOG_TAG, "createHeader ByteArrayOutputStream exception : "+ e.toString());
            }
